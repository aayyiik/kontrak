...
<div>
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('contract.vendor-update', ['contract' => $contract->id])}}" method="POST">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-md-5 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('number') is-invalid @enderror" value="{{$number ?? old('number')}}" id="number" name="number" placeholder="Uraian number">
                            @error('number')
                    ...
                    <div class="col-md-2 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('director') is-invalid @enderror" value="{{$director ?? old('director')}}" id="director" name="director" placeholder="director">
                            @error('director')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-2 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('phone') is-invalid @enderror" value="{{$phone ?? old('phone')}}" id="phone" name="phone" placeholder="phone">
                            @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('address') is-invalid @enderror" value="{{$address ?? old('address')}}" id="address" name="address" placeholder="address">
                            @error('address')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
