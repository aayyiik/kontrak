...
@section('dashboard')
    <div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('contract.legal-approval', ['contract'=>$contracts->id, 'vendor'=>$contracts->vendor_id]) }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group shadow-textarea">
                        ...
                        <textarea class="form-control z-depth-1" name="review_contract" id="exampleFormControlTextarea6" rows="3" placeholder="Write something here..."></textarea>
                    </div>
