...
@section('dashboard')
    <div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('contract.svp-approval', ['contract' => $contracts->id]) }}" method="POST">
                    @csrf
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status_id" id="exampleRadios1" value="11" checked>
