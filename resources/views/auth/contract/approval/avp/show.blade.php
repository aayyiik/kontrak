...
@section('dashboard')
    <div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('contract.avp-approval', ['contract'=>$contracts->id, 'vendor'=>$contracts->vendor_id]) }}" method="POST">
                    @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('contract.avp-approval', ['contract'=>$contracts->id, 'vendor'=>$contracts->vendor_id]) }}" method="POST">
                    @csrf
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status_id" id="exampleRadios1" value="7" disabled>
                        <label class="form-check-label" for="exampleRadios1">
                            Accept
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status_id" id="exampleRadios2" value="3" disabled>
                        <label class="form-check-label" for="exampleRadios2">
                            Reject
                        </label>
                    </div>
                    <div class="form-group shadow-textarea">
                        <label for="exampleFormControlTextarea6">Review</label>
                        <textarea class="form-control z-depth-1" name="notes" id="exampleFormControlTextarea6" rows="3" placeholder="Write something here..." disabled></textarea>
                    </div>
                </form>
            </div>            
        </div>
