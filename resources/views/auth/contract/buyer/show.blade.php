                ...
                <table id="pekerjaanTable" class="table table-sm table-hovered table-bordered table-hover table-striped datatable2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;">{{$contract->pivot->status_id}}</td>
                            <td class="text-center" style="vertical-align: middle;"> <a href="{{route('contract.buyer-show', $contract->id)}}" class="btn btn-primary btn-xs"><b>Detail</b></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
