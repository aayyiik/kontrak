            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{route('contract.avp')}}" class="nav-link @yield('active-contract')">
                                <i class="nav-icon fas fa-chart-line fa-xs"></i>
                                <p>
                                    Contract AVP
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{route('contract.vp')}}" class="nav-link @yield('active-contract')">
                                <i class="nav-icon fas fa-chart-line fa-xs"></i>
                                <p>
                                    Contract VP
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{route('contract.dku')}}" class="nav-link @yield('active-contract')">
                                <i class="nav-icon fas fa-chart-line fa-xs"></i>
                                <p>
                                    Contract DKU
                                </p>
